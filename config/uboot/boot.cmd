...
#
# Please edit /boot/boot.env to set supported parameters
#
...
fatload ${bootdev} 0x20800000 /boot.env && env import -t 0x20800000 ${filesize}

if test -n "${rootdev}"; test $? != 0; then
	echo 'Please set "rootdev" before calling this script'
	echo 'or set it in boot.env.'
	exit 22
fi
...
fatload ${bootdev} 0x21800000 /meson8b-onecloud.dtb || exit 1
